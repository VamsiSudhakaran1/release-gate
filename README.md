...
- **Precision over recall — we don't cry wolf.** When the analyzer can't *prove* a real risk it
  ...
  the [60-case corpus](benchmark/RESULTS.md) now carries ≥2 vulnerable and ≥2 clean look-alikes for
