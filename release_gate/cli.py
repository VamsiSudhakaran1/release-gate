...
Version: 0.7.4 — adds live agent runtime (--agent) and repo audit (badge, CI summary)
"""
import os
import sys
import yaml
...
def _print_score_report(scoring, project, evals, traces, impact, runtime=None, full=False):
    ...
    print("\n" + "=" * 80)
    print("\U0001f6aa release-gate  |  Readiness Scorer  v0.7.4")
    print("=" * 80 + "\n")
...
def run_evidence_pack_command(config_path, evals_path, traces_path, output_dir,
    ...
    print("\n\U0001f6aa release-gate  |  Evidence Pack  v0.7.4\n")
...
def print_help():
    """Print help message"""
    print("\n" + "="*80)
    print("\U0001f6aa release-gate v0.7.4  — AI release decision engine")
    print("="*80)
    print("\nUsage:")
